...
import {
    ...
    User, Repeat, Phone, CheckCircle, Clock, Download,
...
const CallIcon = (props: any) => <Phone {...props} size={40} />;
...
const CampaignDetailsVoice: React.FC = () => {
                            ...
                            <div className="campaign-main-content">
                                ...
                                <div className="campaign-header">
                                    <div className="campaign-title-wrapper">
                                        <h1 className="campaign-title">Christmas Voice Campaign</h1>
                                    ...
                                    <div className="campaign-settings-container">
                                        ...
                                        {showDropdown && (
                                            <div className="campaign-dropdown-menu">
                                                ...
                                                <div className="dropdown-item" onClick={() => { router.push('/campaign/campaign-details-voice/edit-campaign-voice'); setShowDropdown(false); }}>
                                                    <EditIcon />
                                ...
                                <div className="stats-cards">
                                    <div className="stat-card">
                                        <div className="stat-card-header">
                                            <span className="stat-card-label">Calls Sent</span>
                                            <span className="stat-card-badge">↑+12%</span>
                                        </div>
                                        <div className="stat-card-value">1,209</div>
                                        <CallIcon className="stat-card-icon" />
                                    </div>

                                    <div className="stat-card">
                                        <div className="stat-card-header">
                                            <span className="stat-card-label">Answered</span>
                                            <span className="stat-card-badge">↑+12%</span>
                                        </div>
                                        <div className="stat-card-value">1,209</div>
                                    ...
                                    <div className="stat-card">
                                        <div className="stat-card-header">
                                            <span className="stat-card-label">Pending Calls</span>
                                            <span className="stat-card-badge">↑+12%</span>
                                        </div>
                            ...
                            <aside className="campaign-sidebar">
                                ...
                                <div className="sidebar-card">
                                    ...
                                    <ul className="cost-breakdown-list">
                                        ...
                                        <li className="cost-item">
                                            <span className="cost-label">Call</span>
...
export default CampaignDetailsVoice;
